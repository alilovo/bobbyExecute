# Boot-Critical Artifact Preparation

Status: pointer only.

The boot-critical file list and operator procedure now live in:

- [`docs/06_journal_replay/staging-live-preflight-runbook.md`](docs/06_journal_replay/staging-live-preflight-runbook.md)

Use that runbook plus:
...
This file remains only as a historical pointer.
